defmodule Envoy.Api.V2.Filter.Http.Gzip do
  ...
  field :compression_level, 3, type: Envoy.Api.V2.Filter.Http.Gzip.CompressionLevel.Enum, enum: true
  field :compression_strategy, 4, type: Envoy.Api.V2.Filter.Http.Gzip.CompressionStrategy, enum: true
...
defmodule Envoy.Api.V2.Filter.Http.Gzip.CompressionLevel do
  use Protobuf, syntax: :proto3
...
defmodule Envoy.Api.V2.Filter.Http.Gzip.CompressionLevel.Enum do
...
defmodule Envoy.Api.V2.Filter.Http.Gzip.CompressionStrategy do
  use Protobuf, enum: true, syntax: :proto3
