defmodule Envoy.Api.V2.Filter.FaultDelay do
  ...
  field :type, 1, type: Envoy.Api.V2.Filter.FaultDelay.FaultDelayType, enum: true
  field :percent, 2, type: :uint32
  field :fixed_delay, 3, type: Google.Protobuf.Duration, oneof: 0
end

defmodule Envoy.Api.V2.Filter.FaultDelay.FaultDelayType do
