defmodule Envoy.Config.Bootstrap.V2.Bootstrap do
  ...
  defstruct [:node, :static_resources, :dynamic_resources, :cluster_manager, :flags_path, :stats_sinks, :stats_config, :stats_flush_interval, :watchdog, :tracing, :rate_limit_service, :runtime, :admin]
...
defmodule Envoy.Config.Bootstrap.V2.Bootstrap.DynamicResources do
  ...
  field :deprecated_v1, 4, type: Envoy.Config.Bootstrap.V2.Bootstrap.DynamicResources.DeprecatedV1, deprecated: true
end
