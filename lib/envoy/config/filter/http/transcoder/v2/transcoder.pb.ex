defmodule Envoy.Config.Filter.Http.Transcoder.V2.GrpcJsonTranscoder do
  ...
  @type t :: %__MODULE__{
    ...
    services:             [String.t],
    print_options:        Envoy.Config.Filter.Http.Transcoder.V2.GrpcJsonTranscoder.PrintOptions.t
  }
  ...
  field :print_options, 3, type: Envoy.Config.Filter.Http.Transcoder.V2.GrpcJsonTranscoder.PrintOptions
end
