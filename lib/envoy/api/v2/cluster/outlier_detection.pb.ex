defmodule Envoy.Api.V2.Cluster.OutlierDetection do
  ...
  defstruct [:consecutive_5xx, :interval, :base_ejection_time, :max_ejection_percent, :enforcing_consecutive_5xx, :enforcing_success_rate, :success_rate_minimum_hosts, :success_rate_request_volume, :success_rate_stdev_factor, :consecutive_gateway_failure, :enforcing_consecutive_gateway_failure]
