defmodule Envoy.Api.V2.Filter.Network.ClientSSLAuth do
  ...
  @type t :: %__MODULE__{
    ...
    ip_white_list:    [Envoy.Api.V2.CidrRange.t]
  }
  ...
  field :ip_white_list, 4, repeated: true, type: Envoy.Api.V2.CidrRange
end
