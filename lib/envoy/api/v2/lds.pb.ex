defmodule Envoy.Api.V2.Listener do
  ...
  defstruct [:name, :address, :filter_chains, :use_original_dst, :per_connection_buffer_limit_bytes, :metadata, :deprecated_v1, :drain_type, :listener_filters]

  field :name, 1, type: :string
  field :address, 2, type: Envoy.Api.V2.Address
  ...
  field :metadata, 6, type: Envoy.Api.V2.Metadata
...
defmodule Envoy.Api.V2.ListenerDiscoveryService.Service do
  ...
  rpc :StreamListeners, stream(Envoy.Api.V2.DiscoveryRequest), stream(Envoy.Api.V2.DiscoveryResponse)
