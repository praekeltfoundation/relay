defmodule Envoy.Config.Filter.Http.HealthCheck.V2.HealthCheck do
  ...
  @type t :: %__MODULE__{
    ...
    cluster_min_healthy_percentages: %{String.t => Envoy.Api.V2.Core.Percent.t}
  }
  ...
  field :cluster_min_healthy_percentages, 4, repeated: true, type: Envoy.Config.Filter.Http.HealthCheck.V2.HealthCheck.ClusterMinHealthyPercentagesEntry, map: true
end
...
defmodule Envoy.Config.Filter.Http.HealthCheck.V2.HealthCheck.ClusterMinHealthyPercentagesEntry do
  ...
  @type t :: %__MODULE__{
    key:   String.t,
    value: Envoy.Api.V2.Core.Percent.t
  }
  defstruct [:key, :value]

  field :key, 1, type: :string
  field :value, 2, type: Envoy.Api.V2.Core.Percent
end
