defmodule Envoy.Api.V2.Route.VirtualHost do
  ...
  defstruct [:name, :domains, :routes, :require_tls, :virtual_clusters, :rate_limits, :request_headers_to_add, :response_headers_to_add, :response_headers_to_remove, :cors, :auth]
...
defmodule Envoy.Api.V2.Route.CorsPolicy do
  ...
  defstruct [:allow_origin, :allow_methods, :allow_headers, :expose_headers, :max_age, :allow_credentials, :enabled]
...
defmodule Envoy.Api.V2.Route.RouteAction do
  ...
  defstruct [:cluster_specifier, :host_rewrite_specifier, :cluster_not_found_response_code, :metadata_match, :prefix_rewrite, :timeout, :retry_policy, :request_mirror_policy, :priority, :request_headers_to_add, :response_headers_to_add, :response_headers_to_remove, :rate_limits, :include_vh_rate_limits, :hash_policy, :use_websocket, :cors]
...
defmodule Envoy.Api.V2.Route.RouteAction.HashPolicy do
  ...
  field :connection_properties, 3, type: Envoy.Api.V2.Route.RouteAction.HashPolicy.ConnectionProperties, oneof: 0
end
...
defmodule Envoy.Api.V2.Route.RateLimit.Action do
  ...
  field :destination_cluster, 2, type: Envoy.Api.V2.Route.RateLimit.Action.DestinationCluster, oneof: 0
  ...
  field :header_value_match, 6, type: Envoy.Api.V2.Route.RateLimit.Action.HeaderValueMatch, oneof: 0
end
