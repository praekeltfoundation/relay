defmodule Envoy.Api.V2.Filter.Http.GrpcJsonTranscoder do
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
    descriptor_set:       {atom, any},
    services:             [String.t],
    print_options:        Envoy.Api.V2.Filter.Http.GrpcJsonTranscoder.PrintOptions.t
  }
  ...
  field :print_options, 3, type: Envoy.Api.V2.Filter.Http.GrpcJsonTranscoder.PrintOptions
end

defmodule Envoy.Api.V2.Filter.Http.GrpcJsonTranscoder.PrintOptions do
  use Protobuf, syntax: :proto3
  ...
  defstruct [:add_whitespace, :always_print_primitive_fields, :always_print_enums_as_ints, :preserve_proto_field_names]
